<template>
  <div>
    ...
    >
      ...
      <v-list>
        ...
        <v-list-tile>
          ...
          <v-list-tile-title> Compact Millions </v-list-tile-title>
        </v-list-tile>
        <v-list-tile>
          <v-list-tile-action>
            <v-switch v-model="switchEthereum" color="purple" />
          </v-list-tile-action>
          <v-list-tile-title> Ethereum (ETH) </v-list-tile-title>
        </v-list-tile>
        <v-list-tile>
          <v-list-tile-action>
            <v-switch v-model="tetherSwitch" color="purple" />
          </v-list-tile-action>
          <v-list-tile-title> Tether (USDT) </v-list-tile-title>
        </v-list-tile>
      </v-list>
      <v-divider />
      <v-list class="py-0">
    ...
    <v-toolbar app fixed>
      <v-layout row wrap align-center fluid class="tooltip-container--title">
        <v-flex xs5 sm4 class="text-xs-left tooltip-container--refresh">
          <v-tooltip
            bottom
            attach=".tooltip-container--title"
            content-class="tooltip-content--refresh"
          >
            <v-btn
              slot="activator"
              icon
        ...
        <v-flex xs2 sm4 class="text-xs-center">
          <v-tooltip
            ...
            min-width="25rem"
            attach=".tooltip-container--title"
            content-class="tooltip-content--title"
          >
        ...
        <v-flex
          xs5
          sm4
          class="text-xs-right menu-container--dropdown tooltip-container--cast"
        >
          <v-tooltip
            v-if="castButtonVisibility"
            bottom
            attach=".tooltip-container--cast"
            content-class="tooltip-content--cast"
          >
            <v-btn
              slot="activator"
              icon
              :loading="castConnected === 1"
              @click="toggleCastIcon"
            >
              <v-icon
                v-if="castConnected === 2"
                color="blue"
              >
                cast_connected
              </v-icon>
              <v-icon v-else color="inherit">
                cast
              </v-icon>
            </v-btn>
